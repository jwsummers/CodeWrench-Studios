    ...
    >
      ...
      <div className="relative z-10 p-8 rounded-md bg-opacity-50 max-w-3xl mx-auto text-center">
        ...
        <p className="mt-4 text-lg text-gray-100">
          At <span className="text-blue-500">CodeWrench Studios</span>, I are passionate about delivering impactful digital solutions that drive results and exceed expectations.
        </p>
